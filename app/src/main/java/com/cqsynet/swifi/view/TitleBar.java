 ...
 * 版权所有
 *
 * 功能描述：“我的频道”的对应的GridView。
 *
 *
 * 创建标识：luchaowei 20141126
 */
...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs) {
        ...
        mTvTitle = findViewById(R.id.tvTitle_titlebar_layout);
        mLeftIcon = findViewById(R.id.ivBack_titlebar_layout);
        mRightIcon = findViewById(R.id.ivMenu_titlebar_layout);
